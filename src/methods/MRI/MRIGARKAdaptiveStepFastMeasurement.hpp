...
public:
	...
	MRIGARKAdaptiveStepFastMeasurement(MRICoefficients* coeffs_, SingleRateMethodCoefficients* inner_coeffs_, Problem* problem, int problem_dimension_, WeightedErrorNorm* err_norm_) :
