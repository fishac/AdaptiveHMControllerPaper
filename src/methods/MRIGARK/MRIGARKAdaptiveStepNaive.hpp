...
public:
	...
	implicit_residual(&(MRIGARKAdaptiveStepNaive::inner_rhs_funcs)),
	implicit_residual_jacobian(&(MRIGARKAdaptiveStepNaive::inner_rhs_funcs)),
	explicit_rhs(&(MRIGARKAdaptiveStepNaive::inner_rhs_funcs)),
	explicit_rhs_jacobian(&(MRIGARKAdaptiveStepNaive::inner_rhs_funcs)),
	dirk(problem, inner_coeffs_, &(MRIGARKAdaptiveStepNaive::explicit_rhs), &(MRIGARKAdaptiveStepNaive::explicit_rhs_jacobian), problem_dimension_, err_norm_, false),
	newton_solver(&(MRIGARKAdaptiveStepNaive::implicit_residual), &(MRIGARKAdaptiveStepNaive::implicit_residual_jacobian), 20, 0.1, problem_dimension_, err_norm_)
	{
		coeffs = coeffs_;
