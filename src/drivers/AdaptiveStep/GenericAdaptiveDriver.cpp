...
void run(Problem* problem, MRICoefficients* coeffs, const char* tol_string, WeightedErrorNorm* err_norm) {
	...
	printf("\n%s Problem.\n", problem->name);
	driver.run(problem, coeffs, tol_string, err_norm, H_0, M_0, &output_tspan, &Y_true);
}
