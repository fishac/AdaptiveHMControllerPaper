...
public:
	...
	void run(Problem* problem, MRICoefficients* coeffs, const char* tol_string, WeightedErrorNorm* err_norm, double H_0, int M_0, vec* output_tspan, mat* Y_true) {
		/*
		double k1_CC[1] = { 0.42 }; 
		double k2_CC[1] = { 0.44 }; 
		...
		run_single_mrigark_method(problem, coeffs, tol_string, err_norm, &CCcontroller, H_0, M_0, Y_true, output_tspan);
		...
		run_single_mrigark_method(problem, coeffs, tol_string, err_norm, &LLcontroller, H_0, M_0, Y_true, output_tspan);
		...
		run_single_mrigark_method(problem, coeffs, tol_string, err_norm, &pimrcontroller, H_0, M_0, Y_true, output_tspan);
		...
		run_single_mrigark_method(problem, coeffs, tol_string, err_norm, &pidmrcontroller, H_0, M_0, Y_true, output_tspan);
		*/
		double k1_i[1] = { 1.0 };
		double k2_i[1] = { 0.0 }; 
		...
		run_single_mrigark_method(problem, coeffs, tol_string, err_norm, &icontroller, H_0, M_0, Y_true, output_tspan);
		...
		run_single_mrigark_method(problem, coeffs, tol_string, err_norm, &picontroller, H_0, M_0, Y_true, output_tspan);
		...
		run_single_mrigark_method(problem, coeffs, tol_string, err_norm, &pidcontroller, H_0, M_0, Y_true, output_tspan);
		...
		run_single_mrigark_method(problem, coeffs, tol_string, err_norm, &gcontroller, H_0, M_0, Y_true, output_tspan);
	
	}

	void run_single_mrigark_method(Problem* problem, MRICoefficients* coeffs, const char* tol_string, WeightedErrorNorm* err_norm, Controller* controller, double H_0, int M_0, mat* Y_true, vec* output_tspan) {
		if (coeffs->primary_order == 1 || coeffs->primary_order == 2) {
			HeunEulerERKCoefficients inner_coeffs;
			run_single_mrigark_method_with_coeffs(problem, coeffs, &inner_coeffs, tol_string, err_norm, controller, H_0, M_0, Y_true, output_tspan);
	...
	void run_single_mrigark_method_with_coeffs(Problem* problem, MRICoefficients* coeffs, SingleRateMethodCoefficients* inner_coeffs, const char* tol_string, WeightedErrorNorm* err_norm,  Controller* controller, double H_0, int M_0, mat* Y_true, vec* output_tspan) {
		controller->reset();
