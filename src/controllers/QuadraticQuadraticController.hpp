#ifndef QUADRATICQUADRATICCONTROLLER_DEFINED__
#define QUADRATICQUADRATICCONTROLLER_DEFINED__

#include "Controller.hpp"

using namespace arma;

class QuadraticQuadraticController : public Controller {
public:
	double Hnm2_pow;
	double Hnm1_pow;
	double Hn_pow;
	...
	QuadraticQuadraticController(double P_, double p_, double tol_, double safety_factor_, double k1_[3], double k2_[3], Controller* initial_controller_) {
		name = "QuadraticQuadratic";
		P = P_;
		p = p_;
		tol = tol_;
