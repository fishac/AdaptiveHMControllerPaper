#ifndef LINEARLINEARCONTROLLER_DEFINED__
#define LINEARLINEARCONTROLLER_DEFINED__

#include "Controller.hpp"

using namespace arma;

class LinearLinearController : public Controller {
public:
	double Hnm1_pow;
	double Hn_pow;
	double H_essnm1_pow;
	...
	LinearLinearController(double P_, double p_, double tol_, double safety_factor_, double* k1_, double* k2_, Controller* initial_controller_) {
		name = "LinearLinear";
		P = P_;
		p = p_;
		tol = tol_;
